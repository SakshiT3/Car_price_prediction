...
import pickle
model = pickle.load(open(r'C:\Users\sarthak\Desktop\Projects\Car_price_Predictor\RF_price_predicting_model.pkl','rb'))
...
def main():
    ...
    st.image(
            "https://m.hondacarindia.com/content/mobile/images/home_banner/banner-m-e-hev.jpg",
            width=500, 
        )
    st.write('')
    st.write('')
